...
For the digitization pipeline (see ROADMAP Phase 1.5, implemented in `scripts/digitize/`
reusing `lib/transpose`), extraction uses bounding-box OCR (Tesseract + geometry, not a
VLM — see D-16):
